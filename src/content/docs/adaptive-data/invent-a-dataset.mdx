...
| `dataset_prompt`             | No          | Description of the data to generate. Used to select source material and steer generation. Generated from your domain selections when omitted. Maximum 10,000 characters. |
...
Use `dataset_prompt` to describe the specific data you need in plain language:

```python
dataset = client.datasets.invent(
    domains=["medical"],
    rows=1000,
    dataset_prompt="Patient-facing answers in plain language.",
)
```
