...
`language_expansion` uses the same structure as [language expansion in Adaptive Data](/adaptive-data/configure-adaptive-data#expand-across-languages-and-locales):
