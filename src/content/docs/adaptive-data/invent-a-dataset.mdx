...
dataset = client.datasets.invent(
    dataset_prompt="A dataset of medical question-answer pairs covering diagnoses, treatments, drug explanations, and healthcare roles. Each entry includes a prompt and a detailed, expert-generated response."
    rows=1000,
    name="Clinical Q&A",
)
...
To invent a dataset, you must specify one of:

| Parameter            |Notes                                                                                                                                                                    |
| -------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `dataset_prompt`      | Description of the data to generate. Generated from your domain selections when omitted. Maximum 10,000 characters. |
| `domains`             | Domain codes to generate from. Provide at least one domain or subdomain. See [Choose domains and subdomains](#choose-domains-and-subdomains).                            |
| `subdomains`          | Qualified subdomain codes that narrow generation. Provide at least one domain or subdomain.                                                                              |
