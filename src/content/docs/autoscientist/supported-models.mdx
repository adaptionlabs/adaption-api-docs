...
| Model                                              | `model` ID                                                   | Size  | Methods  | Supported `training_type` | Supports reasoning training | Min. rows |
| -------------------------------------------------- | ------------------------------------------------------------ | ----- | -------- | ------------------------- | --------------------------- | --------- |
| **SFT / Alignment**                                |                                                              |       |          |                           |                             |           |
...
**Min. rows** is the minimum effective dataset size (base rows plus [augmentation](/autoscientist/data-augmentation)) required to select that model. DPO training requires at least **12,000 rows** regardless of model; see [Row count](#row-count).
